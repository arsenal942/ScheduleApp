    ...
    >
      <div style={{ width: "100%", maxWidth: 360, textAlign: "center" }}>
        ...
        {error && (
          ...
          >
            {error === "AccessDenied"
              ? "Access denied — your email is not authorised."
        ...
        >
          <svg width="18" height="18" viewBox="0 0 24 24">
            ...
            />
            <path
              d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18A11.96 11.96 0 0 0 1 12c0 1.94.46 3.77 1.18 5.27l3.66-3.18z"
              fill="#FBBC05"
            />
            <path
